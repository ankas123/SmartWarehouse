 ...
 */
public class Accountdetails extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutInflater.inflate(R.layout.content_accountdetails, coordinatorLayout);
